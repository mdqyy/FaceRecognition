...
int faceDetector::runFaceDetector(IplImage *input)
{
	...
	/*cvNamedWindow("faceClipping");
	cvShowImage("faceClipping", input);*/
	...
	//cvNamedWindow("faceClipping2");
	//cvShowImage("faceClipping2", gray);
    ...
    if ( cascade )
    {
      ...
      //      IplImage *in=clipDetectedFace(input);
		...
		//	CvRect* r = (CvRect*)cvGetSeqElem( faces, i );
			...
			cvCircle( input, center, radius,  CV_RGB(255,0,0), 3, 8, 0 );*/
